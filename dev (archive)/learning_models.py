...
import ml_model_price, ml_models, nn_model_buy, nn_model_price
import time
...
def train_and_evaluate_models(
    ...
    ready_datasets = list(set(["_".join(elem.split("_")[-5:-1]) for elem in educated_model]))
    save_flag = True
    for filename in csv_files:
        total_time = time.time()
        sep_title = "_".join(filename.split("_")[1:5])
        # if "cl" in filename:
        #     continue
        # if sep_title in ready_datasets:
        #     continue
        # if "class" in file:
        #     continue
        # counter += 1
        ...
        for model_name, model_obj in models_dict.items():
            postfix = filename.split("\\")[2].replace("re", "R")
            postfix = postfix.replace("cl", "C").replace(".csv", "")
            ...
            if task_type not in model_type:
                continue
            ...
            if pred_time > 5:
                print("File didn't saved, because model is very slowly.")
            else:
        ...
        if save_flag:
            ...
            print("file saved.")
            print("Total Time: ", str(round(time.time() - total_time, 2)))
...
if __name__ == "__main__":
    file_name = "file_stat.csv"
    from sklearn.linear_model import LinearRegression
    from sklearn.ensemble import RandomForestRegressor

    models_dict = {
        # "LinearRegression": {"type_task": ["re"],
        #                      "model": LinearRegression,
        #                      "params": {}},
        "BayesianRidge": {"type_task": ["re"],
                          "model": ml_models.AlgorithmBayesianRidge,
                          "params": {}},
        "AlgorithmMLPRegressor": {"type_task": ["re"],
                                  "model": ml_models.AlgorithmMLPRegressor,
                                  "params": {}},
        "BaggingRegressor": {"type_task": ["re"],
                             "model": ml_models.AlgorithmBaggingRegressor,
                             "params": {}},
        # "VotingRegressor": {"type_task": ["re"],
        #                     "model": ml_models.AlgorithmVotingRegressor,
        #                     "params": {}},
        "LightGBM": {"type_task": ["re"],
                     "model": ml_models.AlgorithmLightGBMRegressor,
                     "params": {}},
        "CatBoost": {"type_task": ["re"],
                     "model": ml_models.AlgorithmCatBoostRegressor,
                     "params": {}},
        "XGBoost": {"type_task": ["re"],
                    "model": ml_models.AlgorithmXGBoostRegressor,
                    "params": {}},
        "LogisticRegressionClf": {"type_task": ["cl"],
                    "model": ml_models.AlgorithmLogisticRegressionClf,
                    "params": {}},
        "TreeClassifierClf": {"type_task": ["cl"],
                    "model": ml_models.AlgorithmDecisionTreeClassifierClf,
                    "params": {}},
        "ForestClassifierClf": {"type_task": ["cl"],
                    "model": ml_models.AlgorithmRandomForestClassifierClf,
                    "params": {}},
        "SVCClf": {"type_task": ["cl"],
                    "model": ml_models.AlgorithmSVCClf,
                    "params": {}},
        "NaiveBayesClf": {"type_task": ["cl"],
                    "model": ml_models.AlgorithmNaiveBayesClf,
                    "params": {}},
        "KNeighborsClf": {"type_task": ["cl"],
                    "model": ml_models.AlgorithmKNeighborsClf,
                    "params": {}},
        "BoostingClassifierClf": {"type_task": ["cl"],
                    "model": ml_models.AlgorithmGradientBoostingClassifierClf,
                    "params": {}},
        # "XGBoostClassifierClf": {"type_task": ["cl"],
        #             "model": ml_models.AlgorithmXGBoostClassifierClf,
        #             "params": {}},
        # "CatBoostClf": {"type_task": ["cl"],
        #             "model": ml_models.AlgorithmCatBoostClassifierClf,
        #             "params": {}},
        # "GBMClassifierClf,": {"type_task": ["cl"],
        #             "model": ml_models.AlgorithmLightGBMClassifierClf,
        #             "params": {}},
        "MLPClassifierClf": {"type_task": ["cl"],
                    "model": ml_models.AlgorithmMLPClassifierClf,
                    "params": {}},
        # "Lass_1": {"type_task": ["re"],
